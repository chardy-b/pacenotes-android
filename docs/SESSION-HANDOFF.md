...
- WIL-10 curve-classification implementation/static-review candidate is present: it consumes only app-owned normalized geometry and conservatively detects candidates using synthetic fixtures. Candidates longer than 250 m, or with any per-step heading change over 60°, are suppressed; completion remains subject to the final-head CI stated below.
