...
| P0-04 | 🟡 Implement geometry normalization and distance/heading primitives | P0-03 | 16k–28k | In progress: pure `pacenotes` module and distance/heading primitives are implemented; remaining normalization must cover meter projection, resampling, duplicates, and discontinuities. |
